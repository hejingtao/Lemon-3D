...
// var DEFAULT_URL = '/assets/libs/pdf/viewer/test2.pdf';
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/assets/libs/pdf/viewer/images/';
  PDFJS.workerSrc = '/assets/libs/pdf/pdf.worker.js';
  PDFJS.cMapUrl = '/assets/libs/pdf/viewer/cmaps/';
